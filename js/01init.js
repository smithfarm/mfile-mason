...
MFILE.html = {
   auth_dialog: "<br><br><br>Username: <input id='username' size='15' maxlength='9' /><br>Password: <input id='password' type='password' size='20' maxlength='20' /><br><br><br>&nbsp;",
   main_menu: "<H2>Main menu</H2>1. Administer codes<br>2. Administer files<br>3. Test LDAP<br>4. View cookies<br>5. Rest in the Self<br>6.  Logout<br><br>Your selection: <input id='getchar' size=2 maxlength=1 style='width: 10px;'>&nbsp;</input><br><br><br>",
   ...
   press_any_key: "<br><br>Press any key to continue: <input id='continue' size='1' maxlength='2' /><br><br><br>",
